...
WHERE TABLE_SCHEMA = DATABASE()
  AND TABLE_NAME IN (
    ...
    'subject_class_assignments', 'academic_score_records', 'canonical_academic_scores', 'canonical_ges_assessments',
...
WHERE TABLE_SCHEMA = DATABASE()
  AND TABLE_NAME IN (
    ...
    'class_subjects', 'subject_class_assignments', 'academic_score_records', 'canonical_academic_scores', 'canonical_ges_assessments',
    'assessment_scores', 'assessments', 'exam_scores', 'exams',
    'examination_marks', 'examinations', 'examination_subjects',
    'report_cards', 'student_assessments', 'result_publications', 'result_blocks',
    'student_attendance', 'attendance_sessions', 'result_signatures',
