...
export function buildAIRegistryDiagnostics({ actor, environment = process.env.NODE_ENV ?? 'development', canAccess, modules = [], capabilityRegistry, toolRegistry, validationErrors = [], productionData = {} }) {
