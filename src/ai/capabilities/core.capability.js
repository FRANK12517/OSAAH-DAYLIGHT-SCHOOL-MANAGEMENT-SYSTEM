...
const definitions = [
  ...
  ['finance', 'finance', 'Finance', 'FINANCE', 'Deterministic financial snapshot interpretation metadata.', 'finance.read', ['PROPRIETOR', 'HEADTEACHER', 'ASSISTANT_HEADTEACHER', 'ACCOUNTANT_BURSAR'], 'FINANCE', [['finance.status', 'Read the authoritative financial status.', 'READ'], ['finance.collections', 'Analyze verified collections.', 'ANALYZE'], ['finance.outstanding', 'Analyze outstanding balances.', 'ANALYZE'], ['finance.expenses', 'Analyze verified expenses.', 'ANALYZE'], ['finance.period-comparison', 'Compare verified financial periods.', 'ANALYZE']], ['expectedRevenue', 'totalCollected', 'outstanding', 'collectionRate', 'totalExpenses', 'netFinancialPosition'], ['FINANCIAL']],
