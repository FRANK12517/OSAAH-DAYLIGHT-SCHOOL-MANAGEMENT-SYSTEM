...
registerModule({ moduleKey: 'fee-structure', moduleName: 'Fee Structure', category: 'FEE HUB', route: '/fees', icon: '$', displayOrder: 1, requiredPermission: 'fees.read', roles: ['PROPRIETOR', 'SCHOOL_ADMIN', 'ACCOUNTANT_BURSAR', 'HEADTEACHER'] });
...
registerModule({ moduleKey: 'finance-reports', moduleName: 'Finance Reports', category: 'FINANCE', route: '/finance', icon: '₵', displayOrder: 1, requiredPermission: 'finance.read', roles: ['PROPRIETOR', 'ACCOUNTANT_BURSAR', 'HEADTEACHER'] });
...
registerModule({ moduleKey: 'official-documents', moduleName: 'Official Documents', category: 'ADMINISTRATIVE', route: '/official-documents', icon: '▤', displayOrder: 2, requiredPermission: 'documents.generate', roles: ['PROPRIETOR', 'SCHOOL_ADMIN', 'HEADTEACHER', 'ACCOUNTANT_BURSAR'] });
registerModule({ moduleKey: 'public-website', moduleName: 'Public School Website', category: 'ADMINISTRATIVE', route: '/website', icon: '◇', displayOrder: 3, requiredPermission: null, roles: ['PROPRIETOR', 'SCHOOL_ADMIN'] });
